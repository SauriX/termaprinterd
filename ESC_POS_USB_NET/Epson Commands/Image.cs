...
namespace ESC_POS_USB_NET.EpsonCommands
{
    ...
    {
        private static BitmapData GetBitmapData(Bitmap bmp,double multipliers)
        {
  
                var threshold = 127;
                var index = 0;
                double multiplier = multipliers; // this depends on your printer model.
        ...
        byte[] IImage.Print(Bitmap image,double multplier)
        {
            var data = GetBitmapData(image,multplier);
