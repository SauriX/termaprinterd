...
namespace termalprinterd
{
    public partial class Form1 : Form
    {
        ...
        public Form1(IWebSocketService socketService, IStartUpService startUpService, IPrinterService printer)
        {
            ...
            _cancellationTokenSource = new CancellationTokenSource(); // Fuente de cancelaci�n para el WebSocket

            _webSocketService = socketService;
            _startUpService = startUpService;
            _printerService = printer;

            UpdateButtonState(); // Actualiza el estado del bot�n

        }
        // M�todo para recibir el par�metro de inicio
        ...
        // Actualiza el texto del bot�n seg�n si el inicio autom�tico est� habilitado
        ...
        // Evento para cerrar la aplicaci�n desde el men�
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                lblStatus.Text = $"Estado: Conectando..."; // Muestra el estado de la conexi�n
        ...
        // Funci�n para cargar las impresoras instaladas en el sistema
        private void CargarImpresoras()
        {
            ...
            {
                listBoxImpresoras.Items.Add(printerName); // A�adir cada impresora al ListBox
            }
        }
        ...
        // Evento para probar la impresi�n en una impresora seleccionada
        private void btnProbar_Click(object sender, EventArgs e)
        {
            if (listBoxImpresoras.SelectedItem != null) // Verifica que haya una impresora seleccionada
            {
                ...
                MessageBox.Show($"Probando impresi�n en: {impresoraSeleccionada}"); // Muestra un mensaje de prueba

                // Llamar a la funci�n de prueba de impresi�n
        ...
        // Funci�n para imprimir un ticket de prueba en una impresora
        public async Task TestPrintTicket(string printer)
        {
            var printData = new PrintList
            {
                ...
                commands = new List<PrintCommand> // Define los comandos de impresi�n
                {
                    // Encabezado
                    ...
                    // Detalles de compra
                    new PrintCommand { Action = "bold", Text = "Cant Descripci�n  Precio  Total" },
                    new PrintCommand { Action = "newLine" },
            ...
            _printerService.ProcessPrintData(printData); // Procesa los datos de impresi�n
        }
        ...
        private string GetLocalIPAddress()
        {
            ...
            {
                // Verifica si la interfaz est� activa
                if (networkInterface.OperationalStatus == System.Net.NetworkInformation.OperationalStatus.Up)
                {
                    ...
                    // Identificar el tipo de conexi�n
                    ...
                    {
                        connectionType = "M�vil (Cable del celular)";
                    }

                    // Buscar una direcci�n IP de tipo IPv4
                    foreach (var unicastAddress in networkInterface.GetIPProperties().UnicastAddresses)
                    {
                        if (unicastAddress.Address.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork)
                        {
                            ipAddress = unicastAddress.Address.ToString();
                            Console.WriteLine($"Conexi�n: {connectionType}, IP: {ipAddress}");
                            break;  // Solo toma la primera IP encontrada para esa interfaz
                        }
                    }

                    if (connectionType != "Desconocido")
                        break;  // Si encontramos la conexi�n, detenemos la b�squeda
                }
            }
